...
合计约 **129G**。运行路径：`/root/models/MiniMax-H3-ComfyUI`；备份：`/workdata/ComfyUI/models_backup/MiniMax-H3-ComfyUI`。

## 提示词润色 LLM

| 模型 | 大小 | 用途 |
|---|---:|---|
| Qwen3.6-35B-A3B (bf16) | 67G | SGLang 服务，MiniMax H3 中文提示词润色 |
