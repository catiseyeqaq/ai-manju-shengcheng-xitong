...
Reads storyboard keyframes from ComfyUI/output/film_coherent/storyboard/
...
STORYBOARD = Path("ComfyUI/output/film_coherent/storyboard")
BRIDGE = Path("ComfyUI/output/film_coherent/bridge")
INPUT = Path("ComfyUI/input")
OUT_PREFIX = "video/story_rain_day_v2"
LOG = Path("ComfyUI/logs/story_chain_i2v.log")
...
def main() -> int:
    ...
    out = Path("ComfyUI/logs/story_chain_i2v_jobs.json")
