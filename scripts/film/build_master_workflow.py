...
TEMPLATE = Path("ComfyUI/workflows/video_minimax_h3_i2v_bf16.json")
OUTPUTS = [
    Path("ComfyUI/workflows/film_master_zh_prompt_flux_face_upscale_h3.json"),
    Path("ComfyUI/user/default/workflows/film_master_zh_prompt_flux_face_upscale_h3.json"),
]
