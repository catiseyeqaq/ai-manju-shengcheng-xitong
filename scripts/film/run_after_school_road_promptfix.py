...
OUT = Path("ComfyUI/output/after_school_road_promptfix")
KEY_SRC = Path("ComfyUI/output/after_school_road_vmax/keys")
JOBS = Path("ComfyUI/logs/after_school_road_promptfix_jobs.json")
