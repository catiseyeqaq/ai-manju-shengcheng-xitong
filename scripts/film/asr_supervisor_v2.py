...
SCR = "ComfyUI/scripts/run_after_school_road_60s.py"
OUT = Path("ComfyUI/output/after_school_road")
LOG = Path("ComfyUI/logs/asr_supervisor.log")
    ...
    while count("plates", "asr_plate_*.png") < 4:
        ...
        if subprocess.call(["pgrep", "-f", "stage plates"], stdout=subprocess.DEVNULL) != 0:
            ...
            subprocess.Popen([PYB, "-u", SCR, "--stage", "plates"],
                             stdout=open("ComfyUI/logs/asr_plates.log", "a"),
