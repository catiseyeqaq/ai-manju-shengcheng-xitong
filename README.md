...
- 9 套可直接导入的模板工作流：H3 视频（T2V / 首尾帧 I2V / 角色写真）、麦橘人物与 QwenImage 出图、中文润色全链路，以及写实短剧《城市雨夜漫步》首尾帧 I2V
...
| 文件 | 用途 |
|---|---|
| [`workflows/H3_文生视频.json`](workflows/H3_文生视频.json) | H3 文生视频（带音轨 + Turbo 8 步） |
| [`workflows/H3_图生视频_首尾帧.json`](workflows/H3_图生视频_首尾帧.json) | H3 首尾帧 I2VA 接戏镜头 |
| [`workflows/H3_角色写真_图生视频.json`](workflows/H3_角色写真_图生视频.json) | 角色写真图生视频（只接首帧） |
...
| [`workflows/QwenImage2512_文生图.json`](workflows/QwenImage2512_文生图.json) | QwenImage 2512 本地文生图 |
...
| 文件 | 用途 |
|---|---|
| [`workflows/全链路_中文润色_麦橘_H3.json`](workflows/全链路_中文润色_麦橘_H3.json) | 中文草稿 → 润色 → 麦橘出图 → 修脸放大 → H3 |

#### 项目工作流

| 文件 | 用途 |
|---|---|
| [`workflows/城市雨夜漫步_图生视频_首尾帧.json`](workflows/城市雨夜漫步_图生视频_首尾帧.json) | 写实短剧《城市雨夜漫步》首尾帧 I2V |

配套文档：[`workflows/README_工作流使用说明.txt`](workflows/README_工作流使用说明.txt)、[`workflows/给GPT_制片管线使用说明.md`](workflows/给GPT_制片管线使用说明.md)（制片管线对接说明）、[`workflows/README_城市雨夜漫步_工作流使用说明.md`](workflows/README_城市雨夜漫步_工作流使用说明.md)（项目工作流详解）
...
├── workflows/                      # 9 套模板工作流（H3 视频 / 麦橘 / Qwen 出图 / 全链路 / 城市雨夜漫步）+ 使用说明
...
加载 `workflows/H3_文生视频.json` 等模板，用润色节点处理中文草稿后排队生成。
